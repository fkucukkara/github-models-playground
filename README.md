...
An educational .NET Aspire application demonstrating how to integrate GitHub Models (AI) with a blog summarization service. This project showcases modern cloud-native development practices using .NET 10, Aspire orchestration, and AI-powered content summarization.
...
- **Modern .NET Practices**: Minimal APIs, dependency injection, and configuration management
...
1. **GitHubModelsPlayground.ApiService**
   ...
   - Fetches blog content and generates AI summaries
...
Once running, you can test the summarization endpoint:
...
```json
{
  "summary": "Blog content summarized in two concise sentences..."
}
```
...
2. Access the Swagger UI at `http://localhost:5000/openapi`
3. Test the `/summarize` endpoint with different blog slugs
